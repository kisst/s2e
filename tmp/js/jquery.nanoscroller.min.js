  ...
  NanoScroll = (function() {
    ...
    */
    ...
    NanoScroll.prototype.reset = function() {
      ...
      /*remove extra bottom padding from div with horizonal scroll*/
      this.$content.removeClass('padding15Bottom');
      ...
      if (content.scrollWidth > this.xPane.outerWidth(true)) {
        ...
        /*add bottom padding to div with horizonal scroll*/
        this.$content.addClass('padding15Bottom');
      }
    ...
    */
    ...
    NanoScroll.prototype.scrollTo = function(node) {
      ...
      /* selector of 'node' in the Firefox returns incorrect object,
         for the correct 'offsetTop' or 'offestLeft' values need
         get parent node from the current object */
      //if ($.browser.mozilla)
